...
exports['breadcrumb']=function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
...
'">'+
((__t=( parent.schema_title ))==null?'':_.escape(__t))+
'</a>\n   </li>\n   <li>\n       <a href="#'+
((__t=( parent.fragment ))==null?'':_.escape(__t))+
'">'+
((__t=( parent.title ))==null?'':_.escape(__t))+
'</a>\n   </li>\n';
 }); 
__p+='\n</ul>\n';
}
...
exports['dataPopup']=function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
...
((__t=( property.title ))==null?'':_.escape(__t))+
...
((__t=( child.id ))==null?'':_.escape(__t))+
'_table"></div>\n      </div>\n      ';
 }); 
__p+='\n    </div>\n  </div>\n</div>\n';
 } 
...
((__t=( id ))==null?'':_.escape(__t))+
'" value="'+
((__t=( property[column.id] ))==null?'':_.escape(__t))+
'" class="form-control"/>\n    ';
...
exports['schemaForm']=function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
...
exports['sideviewItem']=function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<a href="'+
...
((__t=( schema.title ))==null?'':_.escape(__t))+
