  ...
  tableViewMock = {
      ...
      get: function () {
        return {
          properties: {
            ...
            "status": {"description": "status", "permission": [], "title": "Status", "type": "string", "unique": false},
            "tenant_id": {
    ...
    collection: {
      ...
      map: function (callback) {
        ...
        _.forEach(listMockup, function (model, key) {
          model = _.extend(model, {
            toJSON: function () {
              return this;
            }
          });
          result[key] = callback(model);
        });
        return result;
      }
    },
...
describe('TableView', function () {
  beforeEach(function () {
    tableView = new TableView(tableViewMock);
  });
  ...
  describe('sort list by name', function () {
    ...
    it('should 1st element to contains "a Test" string', function () {
      tableView.$el.find('tbody:not(.hidden) > tr')[0].firstElementChild.nextElementSibling.innerText.should.to.contains('a Test');
    });

    it('should 2nd element to contains "Test 1" string', function () {
      tableView.$el.find('tbody:not(.hidden) > tr')[1].firstElementChild.nextElementSibling.innerText.should.to.contains('Test 1');
    });

    it('should 3rd element to contains "Test 10" string', function () {
      tableView.$el.find('tbody:not(.hidden) > tr')[2].firstElementChild.nextElementSibling.innerText.should.to.contains('Test 10');
    });
    it('should 4th element to contains "Test 11" string', function () {
      tableView.$el.find('tbody:not(.hidden) > tr')[3].firstElementChild.nextElementSibling.innerText.should.to.contains('Test 11');
    });
    it('should 5th element to contains "Test 12" string', function () {
      tableView.$el.find('tbody:not(.hidden) > tr')[4].firstElementChild.nextElementSibling.innerText.should.to.contains('Test 12');
    });
    it('should 6th element to contains "Test 13" string', function () {
      tableView.$el.find('tbody:not(.hidden) > tr')[5].firstElementChild.nextElementSibling.innerText.should.to.contains('Test 13');
    });
    it('should 7th element to contains "Test 2" string', function () {
      tableView.$el.find('tbody:not(.hidden) > tr')[6].firstElementChild.nextElementSibling.innerText.should.to.contains('Test 2');
    });
    it('should 8th element to contains "Test 3" string', function () {
      tableView.$el.find('tbody:not(.hidden) > tr')[7].firstElementChild.nextElementSibling.innerText.should.to.contains('Test 3');
    });
    it('should 9th element to contains "Test 4" string', function () {
      tableView.$el.find('tbody:not(.hidden) > tr')[8].firstElementChild.nextElementSibling.innerText.should.to.contains('Test 4');
    });
    it('should 10th element to contains "Test 5" string', function () {
      tableView.$el.find('tbody:not(.hidden) > tr')[9].firstElementChild.nextElementSibling.innerText.should.to.contains('Test 5');
    });
  });
  ...
  describe('sort list by name reverse', function () {
    ...
    it('should 1st element to contains "Test 9" string', function () {
      tableView.$el.find('tbody:not(.hidden) > tr')[0].firstElementChild.nextElementSibling.innerText.should.to.contains('Test 9');
    });

    it('should 2nd element to contains "Test 8" string', function () {
      tableView.$el.find('tbody:not(.hidden) > tr')[1].firstElementChild.nextElementSibling.innerText.should.to.contains('Test 8');
    });

    it('should 3rd element to contains "Test 7" string', function () {
      tableView.$el.find('tbody:not(.hidden) > tr')[2].firstElementChild.nextElementSibling.innerText.should.to.contains('Test 7');
    });
    it('should 4th element to contains "Test 6" string', function () {
      tableView.$el.find('tbody:not(.hidden) > tr')[3].firstElementChild.nextElementSibling.innerText.should.to.contains('Test 6');
    });
    it('should 5th element to contains "Test 5" string', function () {
      tableView.$el.find('tbody:not(.hidden) > tr')[4].firstElementChild.nextElementSibling.innerText.should.to.contains('Test 5');
    });
    it('should 6th element to contains "Test 4" string', function () {
      tableView.$el.find('tbody:not(.hidden) > tr')[5].firstElementChild.nextElementSibling.innerText.should.to.contains('Test 4');
    });
    it('should 7th element to contains "Test 3" string', function () {
      tableView.$el.find('tbody:not(.hidden) > tr')[6].firstElementChild.nextElementSibling.innerText.should.to.contains('Test 3');
    });
    it('should 8th element to contains "Test 2" string', function () {
      tableView.$el.find('tbody:not(.hidden) > tr')[7].firstElementChild.nextElementSibling.innerText.should.to.contains('Test 2');
    });
    it('should 9th element to contains "Test 13" string', function () {
      tableView.$el.find('tbody:not(.hidden) > tr')[8].firstElementChild.nextElementSibling.innerText.should.to.contains('Test 13');
    });
    it('should 10th element to contains "Test 12" string', function () {
      tableView.$el.find('tbody:not(.hidden) > tr')[9].firstElementChild.nextElementSibling.innerText.should.to.contains('Test 12');
    });
  });
  ...
  describe('cancel sort list by name', function () {
    ...
    it('should 1st element to contains "Test 1" string', function () {
      tableView.$el.find('tbody:not(.hidden) > tr')[0].firstElementChild.nextElementSibling.innerText.should.to.contains('Test 1');
    });

    it('should 2nd element to contains "Test 10" string', function () {
      tableView.$el.find('tbody:not(.hidden) > tr')[1].firstElementChild.nextElementSibling.innerText.should.to.contains('Test 10');
    });

    it('should 3rd element to contains "Test 11" string', function () {
      tableView.$el.find('tbody:not(.hidden) > tr')[2].firstElementChild.nextElementSibling.innerText.should.to.contains('Test 11');
    });
    it('should 4th element to contains "Test 12" string', function () {
      tableView.$el.find('tbody:not(.hidden) > tr')[3].firstElementChild.nextElementSibling.innerText.should.to.contains('Test 12');
    });
    it('should 5th element to contains "Test 13" string', function () {
      tableView.$el.find('tbody:not(.hidden) > tr')[4].firstElementChild.nextElementSibling.innerText.should.to.contains('Test 13');
    });
    it('should 6th element to contains "Test 2" string', function () {
      tableView.$el.find('tbody:not(.hidden) > tr')[5].firstElementChild.nextElementSibling.innerText.should.to.contains('Test 2');
    });
    it('should 7th element to contains "Test 3" string', function () {
      tableView.$el.find('tbody:not(.hidden) > tr')[6].firstElementChild.nextElementSibling.innerText.should.to.contains('Test 3');
    });
    it('should 8th element to contains "Test 4" string', function () {
      tableView.$el.find('tbody:not(.hidden) > tr')[7].firstElementChild.nextElementSibling.innerText.should.to.contains('Test 4');
    });
    it('should 9th element to contains "Test 5" string', function () {
      tableView.$el.find('tbody:not(.hidden) > tr')[8].firstElementChild.nextElementSibling.innerText.should.to.contains('Test 5');
    });
    it('should 10th element to contains "Test 6" string', function () {
      tableView.$el.find('tbody:not(.hidden) > tr')[9].firstElementChild.nextElementSibling.innerText.should.to.contains('Test 6');
    });
  });
});
